 ...
 */
@ServiceModule("bas")
public class BasFindListService {
	private BasicServiceConfRepository basicServiceConfRepository;
	public BasFindListService() {
		 basicServiceConfRepository = SingleMongoFactory.getBean(BasicServiceConfRepository.class, "service_findlist_conf");
	}
	 ...
	 *    
	 *    {
  "_id" : ObjectId("56186a16bb07c01d0c0a3ac1"),
  "service" : "cus.getCourseListApp",
  "mustkeys" : ["page", "rows"],
  "findkeys" : {
    "industryno" : "",
    "orgid" : "",
  ...
  "collection" : "cus_coursebaseinfo",
  "addkeys" : { },
  "embedkeys" : [{
      "collection" : "mem_organization",
      "method" : "findOne",
      "inkeys" : { },
      "usedkeys" : {
        "orgid" : "_id"
      ...
      "collection" : "cuw_coursewareinfo",
      "method" : "findOne",
      "inkeys" : { },
      "usedkeys" : {
        "cus_coursedetail$cuwidweb" : "_id"
      },
      "needkeys" : ["cusearename"]
    }],
  "replacekeys" : {
    "_id" : "courseid"
  },
  ...
  "returnkeys" : ["courseid", "orgname", "custitle", "cuspicinfo", "feeamt", "regsumnum", "cus_coursedetail"]
}
	 * 
	 * @param request
	 * @return
	 * 
	 */
	@ServiceMethod("getFindList")
	public ResponseObject getFindList(RequestObject request) {
		...
		*/
		...
		if (sortObj.isEmpty()) {
			objectlist = basicRepository.findList(queryObj);
		}else {
			objectlist = basicRepository.findList(queryObj,sortObj);
		}
